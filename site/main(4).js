...
//   console.log("result 1") // Если myNumber больше 20 выводиться эта часть условия, в данном случае НЕТ.
...
//console.log(sum(3, 259));

//Обьекты

var myObject = {
	name: "вася", // свойства
	surname: "Васин",// свойства
	age: 25,// свойства
	getFullName: function() { //метод
		return this.name + " " + this.surname; // свойство this. внутри обьекта означает что мы обращаемся к текущему обьекту.
	}
};

myObject.name = "Петя"; // Переопределили свойство для name
console.log(myObject.name); // вызов свойства
console.log(myObject.getFullName()); // вызов метода

console.log("___________Пример условия if else___________");
// Пример условия
...
var ManchesterUtdWins = 30;

if (ManchesterUtdWins > 20) {
	console.log("2. ManchesterUtd");
}
else {
	console.log("4. ManchesterUtd");
}
console.log("___________Пример цикла for___________");
// Циклы 
